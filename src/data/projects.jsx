...
const projects = [
    {
        image: "",
        title: "LIBRARY ILLIAD USER SYSTEM",
        description: ""
    },
    {
        image: "",
        title: "LIBRARY TRANSACTIFY",
        description: ""
    },
    {
        image: "../assets/ats.png",
        title: "ATTENDANCE TRACKING SYSTEM",
        description: "Developing an attendance tracking system for Purdue lecturers using React and Material UI, with Firebase backend to ensure real-time data updates and secure user authentication. Implemented a user dashboard and set up authentication using Firebase Authentication, facilitating a seamless and secure user experience. Leveraging Firebase Realtime Database for dynamic attendance data management, supporting real-time updates and scalability."
    },
    {
        image: "../assets/campusmart.png",
        title: "CAMPUS MART",
